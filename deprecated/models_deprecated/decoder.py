...
class Transformer(nn.Module):
    def __init__(self, vocab_size=43, hidden_dim=256, pad_token_id=0, 
        ...
        self.positional_encoding = pe.PositionalEncodings(max_position_embeddings, hidden_dim, dropout)
    ...
    def forward(self, src, mask, tgt, tgt_mask, pos_embed=None):
        bs, c, l = src.shape
